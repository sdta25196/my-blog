  ...
  return (
    <div className={styles.navigationPC}>
      <header className={styles.top}>
        <img src={LOGO.src} alt="logo" width='230px' height="113px" />
      </header>
      {
        isDetail ?
          ...
          <aside className={`${styles.bottom} ${fixed ? styles.fixed : ""}`}>
            ...
            {
              nav.map((item) => {
                return <Link href={item.router} key={item.router}>
            ...
            <div className={styles.linkBox}>
              <a href="https://github.com/sdta25196" target="_blank" rel="noreferrer">
                <img src={GITHUB.src} alt="github" className={styles.link} />
              </a>
              <a href="https://valor.blog.csdn.net/" target="_blank" rel="noreferrer">
                <img src={CSDN.src} alt="csdn" className={styles.link} />
              </a>
            </div>
          </aside>
      }
